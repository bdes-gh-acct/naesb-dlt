...
variable "allowed_inbound_cidr_blocks" {
  description = "List of CIDR blocks that can access the vault instances"
  type        = list(string)
  default     = []
}
...
variable "gossip_encryption_key_arn" {
  description = "Encryption key for consul gossip encryption"
  type        = string
  sensitive   = true
}
...
variable "peer_role_arn" {
  description = "Arn used for the peer role to allow vault access"
  type        = string
}

variable "peer_role_name" {
  description = "Name used for the peer role to allow vault access"
  type        = string
}
