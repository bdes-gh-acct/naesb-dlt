...
#  }
  ...
  serverlessv2_scaling_configuration {
    ...
    #content {
      max_capacity             = 16 #lookup(serverlessv2_scaling_configuration.value, "max_capacity", null)
      min_capacity             = 2 #lookup(serverlessv2_scaling_configuration.value, "min_capacity", null)
      #seconds_until_auto_pause = 300 #lookup(serverlessv2_scaling_configuration.value, "seconds_until_auto_pause", null)
    #}
  }
...
resource "aws_rds_cluster_endpoint" "this" {
  ...
  cluster_identifier          = try(aws_rds_cluster_instance.this[0].id, "")
...
module "migration_lambda" {
  ...
  vpc_id     = var.vpc_id
  database   = "postgres"
  # database   = var.is_primary_cluster ? var.database_name : null
  username = var.is_primary_cluster ? var.master_username : null
  password = var.is_primary_cluster ? local.master_password : null
